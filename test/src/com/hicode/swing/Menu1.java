...
public class Menu1 extends javax.swing.JPanel {
    ...
    public Menu1() {
        ...
        listMenu1.addItem(new MenuModel("src\\com\\hicode\\icons\\10.png", "Tìm Sách", MenuModel.MenuType.MENU));
        listMenu1.addItem(new MenuModel("src\\com\\hicode\\icons\\7.png", "Trang Chủ", MenuModel.MenuType.EMPTY));
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gp = new GradientPaint(0, 0, Color.decode("#883E51"), 0, getHeight(), Color.decode("#7B79A1"));
        g2.setPaint(gp);
